  ...
  return (
    <header className="sticky top-0 z-20 flex h-14 items-center justify-between border-b border-border bg-surface/80 px-6 backdrop-blur-xl">
      ...
      <div className="flex items-center gap-2.5">
        ...
        {/* User avatar */}
        <motion.button whileHover={{ scale: 1.02 }} className="flex items-center gap-2 rounded-xl border border-border bg-surface px-2 py-1 transition hover:border-border-strong hover:shadow-sm">
